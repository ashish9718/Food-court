                                ...
                                <table class="table">
                                    ...
                                    <% for(Menu u : list){ %>
										<tr>
											<td><ul><li></ul>
											<td><%=u.getId() %>
											<td><a href="ItemController?action=getBycategory&category=<%=u.getCategory() %>"><%=u.getCategory() %></a>
											<td><a href="MenuController?action=searchByIdForUpdate&id=<%=u.getId() %>">Update</a></td>
											<td><a href="MenuController?action=delete&id=<%=u.getId() %>">Delete</a></td>
