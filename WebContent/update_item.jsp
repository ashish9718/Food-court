...
<%@page import="com.javaproject.services.UserServiceImpl"%>
<%@page import="com.javaproject.models.Menu"%>
<%@page import="java.util.*"%>    
<%
	List<Menu> cats = new UserServiceImpl().getAllMenus();
%>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
											...
											<td><input type="text" name="name" size="22" value="${item.name }" /></td>
										</tr>
										<tr>
											<td width="40%">Cost:</td>
											<td><input type="text" name="cost" size="22" value="${item.cost }"/></td>
										</tr>
										<tr>
											<td colspan="2" width="40%"><input type="submit" value="Update" /></td>
